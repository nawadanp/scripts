...
class Py3status:
    ...
    Nameservers are dynamically found. The domain name is the only one mandatory parameter.
    It's also possible to add other nameservers by appending them in nameservers list.
