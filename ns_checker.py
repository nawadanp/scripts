...
class Py3status:
    ...
    Nameservers are dynamically founds. The domain name is the only one mandatory parameter.
    It's also possible to add others nameservers by appending them in nameservers list.
